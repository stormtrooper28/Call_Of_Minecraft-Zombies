...
public class OnBlockBreakEvent implements Listener {
	...
	public OnBlockBreakEvent(COMZombiesMain z) {
		plugin = z;
		manager = z.manager;
	}
	...
	public void onBlockBreakEvent(BlockBreakEvent interact) {
		...
		if (interact.getBlock().getType() == Material.WALL_SIGN || interact.getBlock().getType() == Material.SIGN || interact.getBlock().getType() == Material.SIGN_POST) {
			Sign sign = (Sign) interact.getBlock().getState();
